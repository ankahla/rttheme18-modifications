...
<div class="row clearfix">
		...
		<div class="product_meta">
			...
			<?php 
				...
				echo ! empty( $sku ) ? sprintf( '<span class="sku_wrapper" itemprop="productID"><span class="sku"><b>%s:</b> %s  </span></span> ', __('Code','rt_theme'), $sku ) : "" ;



				//categories 

				echo '<br><span class="posted_in">' . get_the_term_list( $post->ID, 'product_categories', '<b>'._n(__('Category','rt_theme'),__('Categories','rt_theme'), count( get_the_terms( $post->ID , 'product_categories') ),'rt_theme') .':</b> ', ', ', '' ) . '</span>' ; 
				...
				<div class="doc_icons">
					...
					if(is_array($rt_attached_documents)){
						...
						foreach($rt_attached_documents as $a_file){
							...
							$rt_attached_documents_output .= '[icon_list_line icon="icon-docs"]'.$download_link.'[/icon_list_line]';
	...
	<div class="box one first">
		...
		<div class="tabs_wrap tab-style-three">
		    ...
		    <ul class="tabs clearfix">
				...
				<?php if($content):?><li class="with_icon"><a href="#"><span class="icon-doc-alt"></span><?php _e('Details','rt_theme');?></a></li><?php endif;?>
